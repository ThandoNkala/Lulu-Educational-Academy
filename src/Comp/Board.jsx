    ...
    return(
        ...
        <section>
          ...
          <div className=" flex justify-between items-center  flex-wrap ">
            <div className="group border-[#461B36] h-70 w-90 bg-[url('/woman1.png')] bg-cover bg-center rounded-3xl hover:visible md:block hidden">
            ...
            <div className="border border-dotted border-[#461B36] h-120 w-120 flex justify-center items-center rounded-3xl">
                 <div className=" bg-[url('/MAN.png')] group bg-cover bg-center md:h-110 h-90 md:w-110 w-90 bg-cover rounded-3xl">
            ...
            <div className="border group border-[#461B36] h-70 w-90 bg-[url('/Woman2.png')] bg-cover bg-center rounded-3xl md:block hidden">
