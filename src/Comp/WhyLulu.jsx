   ...
   <div className=' flex justify-around align-center '>  
      <div className=' flex justify-center text-start mt-10 w-250'>
        <p className="text-[#461B36] text-lg font-playfair">At Lulu Academy, we strive for all-round excellence. Our strong academic program empowers learners <br />
         with knowledge and critical thinking skills. Through sport, we promote teamwork, discipline, and <br />
          physical well-being. We also uphold high standards of cleanliness, creating a safe, healthy, and <br />
    ...
    <section>
        <div className='mt-10 flex  flex-wrap justify-around align-center '>
            <div className="bg-[#461B36] h-45 w-100 rounded-2xl">
             ...
             <div className="bg-[url('./src/images/tennis.png')] bg-cover bg-center h-45 w-100 rounded-2xl"></div>
            <div className="bg-[#461B36] h-45 w-100 rounded-2xl">
        ...
        <div className='mt-10 flex flex-wrap justify-around align-center '>
          <div className="bg-[url('./src/images/Raket.png')] bg-cover bg-center h-45 w-100 rounded-2xl"></div>
             <div className="bg-[#461B36] h-45 w-210 rounded-2xl flex justify-between">
                <div>
