function Declaration (){
    return(
       <div>
        <form className="bg-white p-6 md:ml-10 mt-10">
          <div className="mb-4">
            <h1 className="text-[#461B36] font-playfair text-2xl">I,</h1>
                <label className="block text-gray-700 mb-2" htmlFor="email"></label>
                <input className="border border-[#461B36] p-2 md:w-100" type="email" id="email" name="email" required placeholder="Your Name*" />
            ...
            <h1 className="text-[#461B36] font-playfair text-2xl">I,</h1>
              ...
              <button className="bg-gradient-to-r from-[#461B36] to-pink-500 rounded text-white py-2 px-4 rounded md:w-20 w-35" type="submit">Submit</button>
        </form>
       </div>
    );
}
