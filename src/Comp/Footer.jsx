            ...
            <p className='text-[#461B36] mt-5'>Lulu Academy is committed to nurturing well-rounded learners through academic <br />
             excellence, leadership, and innovation — empowering every student to thrive in a <br />
              ...
              <div className="h-10 w-50 flex justify-between mt-5">
                <img className="[#461B36]" src="src/images/line-md_youtube.png" alt="" />
                 <img src="src/images/linkedin.png" alt="" /> 
                  <img src="src/images/hugeicons_instagram.png" alt="" />
                   <img src="src/images/ic_round-facebook.png" alt="" />
              </div>
        </div>
        <div className="flex  flex-wrap justify-between md:w-120 w-90 h-90 items-center md:mt-10 -mt-15 container mx-auto ">
          <div className="md:block hidden">
            <ul className="flex flex-col justify-between h-40">
              ...
              <li className='text-[#461B36]'><Link to="/academics">Academics</Link></li>
              <li className='text-[#461B36]'><Link to="/athletics">Sport</Link></li>
              <li className='text-[#461B36]'><Link to="/aboutus">Our Mission</Link></li>
            </ul>
          </div>
