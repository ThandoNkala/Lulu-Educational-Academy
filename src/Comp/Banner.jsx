          ...
          <div className="h-screen bg-w-1/2 bg-[url('./src/images/game-icons_graduate-cap.png')] bg-contain bg-center bg-no-repeat">
            <div className="md:flex flex-wrap md:justify-between items-center container mx-auto">
              <div className="text-[#461B36] text-center md:text-left md:w-1/2 w-full mt-20">
                ...
                <h1 className="md:text-8xl text-8xl font-normal font-euphoria">
                  Lulu Academy
                </h1>
              </div>

              <div
                className="md:border-40 border-30 
               rounded-full 
               md:h-120  h-80 
               md:w-120  w-80
               position relative top-25  left-10
               border-[#461B36] bg-white
            ...
            <div className="text-white md:w-130 flex justify-evenly items-center shadow-xl/30 rounded-lg bg-white position relative  md:bottom-30 md:left-100">
              <button className="text-xl text-center font-semibold cursor-pointer w-35 border-2 border-[#461B36] text-[#461B36] rounded  p-2 m-2 flex">
                <svg
              ...
              <Link
                to="/admission"
                className=" font-semibold text-xl cursor-pointer md:w-20 w-35 text-center font bg-gradient-to-r from-[#461B36] to-pink-500 rounded p-2 m-2"
              >
                Enroll
              </Link>
            </div>
            <div className="bg-[#461B36] md:h-35 text-white mt-20 flex-col justify-center items-center ">
